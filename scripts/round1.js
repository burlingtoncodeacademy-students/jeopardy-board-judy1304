...
// Get the 'Ready' button element
// const readyButton = document.getElementById('ready-game-button');

// Add an event listener to the button that redirects the player to the Round 1 page when clicked
